  ...
  <div class="dashboard-editor-container">
    ...
    <div>
      <el-tag class="tag-title">
        ...
        <el-radio border :label="1">知识掌握情况</el-radio>
        <el-radio border :label="2">学习情况</el-radio>
      </el-radio-group>
    </div>
  ...
  methods: {
    ...
    getItemInfo0() {
      ...
      dataForMyPage(data1).then(response => {
        ...
        this.option0.title = { text: '理论知识点掌握情况' }
