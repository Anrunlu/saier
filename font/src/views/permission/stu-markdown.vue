  ...
  <div class="components-container">
    <div>
      ...
      <div v-show="homework">
        ...
        <el-button type="warning" icon="upload" :disabled="!hwswitch" style="bottom: 15px; width: 100%" @click="hwsubmit">
          提交作业
        </el-button>
      ...
      <div v-show="experiment">
        ...
        <div class="editor-container">
          ...
          <mavon-editor ref="md" v-model="expcontent" :scroll-style="true" :editable="expswitch" oncopy="return false" oncut="return false" placeholder="test" height="300px" @imgAdd="$imgAdd3" @save="saveStuExp" />
          <el-button icon="el-icon-edit" type="warning" style="width:100%" @click="saveStuExp">保存实验</el-button>
          <el-row :gutter="8">
            <el-col :span="8">
              <el-input v-model="score" class="comment" size="small" disabled placeholder="请输入成绩" />
...
import { recImg, getstuownhw, submitstuownhw, getknowsforstu, submitstuyx, getStuExp, saveStuExp } from '@/api/hwexp'
