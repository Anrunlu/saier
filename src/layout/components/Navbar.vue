  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
		...
		{{this.form.username+' '+this.form.userno}}
...
import { getPerInfo } from '@/api/hwexp'
export default {
  components: {
    Breadcrumb,
    Hamburger,
  ...
  methods: {
    ...
    async logout() {
      ...
      localStorage.removeItem('stucoures')
      localStorage.removeItem('tableidx')
      localStorage.removeItem('useridx')
      localStorage.removeItem('selcoures')
      localStorage.removeItem('username')
      localStorage.removeItem('quesNo')
      localStorage.removeItem('reportno')
      localStorage.removeItem('type')
      localStorage.removeItem('gradecomments')
