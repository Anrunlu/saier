  ...
  data() {
    return {
      ...
      options: {
        ...
        target: 'http://182.92.231.190:9000/kejianupload',
  ...
  methods: {
    ...
    preSlide() {
      ...
      if (this.kjSlideIdx < 1) {
        ...
        this.kejianpic = 'http://182.92.231.190:9000/static/kejian/' + this.selkj.split('|')[1] + '_' + this.selcoures + '_' + this.selkj.split('|')[0] + '_' + '幻灯片' + this.kjSlideIdx + '.PNG?' + version
      }
    },
    nextSlide() {
      this.kjSlideIdx = this.kjSlideIdx + 1
