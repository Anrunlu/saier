<template>
  <div class="dashboard-editor-container">
	...
	<div class="handle-box">
	                ...
	                <el-radio-group v-for="item in alltype" :key="item" v-model="seltype">
	                  <el-radio border :label="item" @change="changetype">{{ item }}</el-radio>
	                </el-radio-group>
	             
	             			   <el-button type="primary" @click="adduser" style="background-color: firebrick;" >新增</el-button>
    ...
    <div v-show="radio===1?true:false">
      ...
      <div>
        ...
        <el-radio-group v-for="item in coures" :key="item" v-model="selcoures">
          <el-radio border :label="item" @change="getyuxiData">{{ item }}</el-radio>
        </el-radio-group>
      </div>
      <div>
		...
		<!-- <el-select v-model="selclass" placeholder="请选择班级" @change="yuxichangeClass">
		  <el-option
		...
		<div>
		  ...
		  <el-radio-group v-for="item in classes" v-model="selclass">
		    <el-radio border :label="item.value" @change="yuxichangeClass">{{ item.value }}</el-radio>
		  </el-radio-group>
		</div>
    ...
    <div v-show="radio===2?true:false" class="table">
      ...
      <div>
       <!-- <el-select v-model="selclass" placeholder="请选择班级" @change="changeClass">
          <el-option
            v-for="item in classes"
            :key="item.value"
            :label="item.label"
		...
		<div>
		  ...
		  <el-radio-group v-for="item in classes" v-model="selclass">
		    <el-radio border :label="item.value" @change="changeClass">{{ item.value }}</el-radio>
		  </el-radio-group>
		</div>
    ...
    <div v-show="radio===3?true:false" class="table">
      ...
      <div>
       <!-- <el-select v-model="selclass" placeholder="请选择班级" @change="expchangeClass">
          <el-option
            v-for="item in classes"
            :key="item.value"
            :label="item.label"
		...
		<div>
		  ...
		  <el-radio-group v-for="item in classes" v-model="selclass">
		    <el-radio border :label="item.value" @change="expchangeClass">{{ item.value }}</el-radio>
		  </el-radio-group>
		</div>
    ...
    <div v-show="radio===4?true:false" class="table">
      ...
      <div>
        <!-- <el-select v-model="selclass" placeholder="请选择班级" @change="examchangeClass">
          <el-option
            v-for="item in classes"
            :key="item.value"
            :label="item.label"
		...
		<div>
		  ...
		  <el-radio-group v-for="item in classes" v-model="selclass">
		    <el-radio border :label="item.value" @change="examchangeClass">{{ item.value }}</el-radio>
		  </el-radio-group>
		</div>
        <el-date-picker
          v-model="examYmdTime"
...
export default {
  ...
  mounted() {
    ...
    //this.selclass = localStorage.getItem('selclass')
    this.changetype()
  },
  methods: {
	 changetype(){'预习作业','课堂作业','实验','考试试卷'
		 if(this.seltype=='预习作业'){
			 this.radio=1
			 this.coures = JSON.parse(localStorage.getItem('coures'))
			 this.selcoures = this.coures[0]
			 this.getData()
		 }
		 if(this.seltype=='课堂作业'){
			  this.radio=2
		 	this.getDatahw()
    ...
    yuxiinfo() {
      const _this = this
      const data1 = { 'userno': localStorage.getItem('userno'), 'coures': _this.selcoures, 'yxidx': _this.selyx,'stuclass':_this.selclass }
    ...
    getData() {
      const _this = this
      _this.selyx = 1
      const data = { 'userno': localStorage.getItem('userno'), 'coures': this.selcoures, 'yxidx': _this.selyx,'stuclass': this.selclass  }
    ...
    getDatahw() {
      ...
      const data = { 'userno': localStorage.getItem('userno'), 'coures': this.selcoures, 'stuclass': this.selclass }
    ...
    // ********************************************************************
    delExamOfStu() {
      const data = { 'owner': localStorage.getItem('userno'), 'userno': '', 'coures': this.selcoures, 'examidx': this.examidx, 'stuclass': this.selclass }
    ...
    extendExamTime() {
      const data = { 'owner': localStorage.getItem('userno'), 'userno': '', 'coures': this.selcoures, 'examidx': this.examidx, 'stuclass': this.selclass, 'exttime': this.examYmdTime }
    ...
    getExamData() {
      ...
      const data = { 'size': that.exampagesize, 'page': that.cur_page, 'coures': that.selcoures, 'userno': localStorage.getItem('userno'), 'examidx': this.examidx, 'stuclass': this.selclass }
